...
class NewsClassifier:
    def __init__(self, api_key: str):
        ...
        self.type_dict = {
            ...
            2: "中国时事（中国） 包括： 法律修订执行、中央及地方政府人事任免、国家新闻机构与传播、反腐败行动、重要会议（如两会）、政府政策发布与解读（如乡村振兴、八项规定）、人权相关案件与议题。",
            3: "经济与商业 包括： 宏观经济数据（GDP、CPI、LPR、失业率、产品产量等）、贸易政策与争端（含关税）、金融市场动态（股市、汇率、利率）、产业发展与监管、企业新闻（经营、并购、投资、丑闻）、消费市场、劳工问题（讨薪、罢工）",
            4: "社会与民生 包括： 中国社会热点事件与争议，打工人就业、犯罪案件与司法审判、公共安全事件（非灾难事故）、民众维权行动、教育医疗议题、人口与生育政策、生活服务问题、特定维稳群体关切（如农民工、退役军人）",
